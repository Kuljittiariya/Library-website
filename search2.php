      ...
      <div class="row">
        ...
        <nav id="main-nav-wrap">
            <ul class="main-navigation">
               <li class="current"><a class="smoothscroll"  href="#intro" title="">SEARCH BOOK</a></li>
               <li><a class="smoothscroll"  onclick="location.href='NEW_requisition.html'" href="NEW_requisition.html">REQUEST</a></li>            
               <li class="highlight with-sep"><a class="smoothscroll" onclick="location.href='memberInfo.html'" href="memberInfo.html" >MY PROFILE</a></li>             
            </ul>
         </nav>
      ...
      <div class="intro-content">
         <div class="row">
            ...
            <div class="col-twelve">
               ...
               <h5>Find your desired book here ..</h5><br><br>
            <center>
...
if(isset($_POST['submitsearch'])){
         ...
         switch($TypeSearch){
            ...
            case "Producer":
            $query = "SELECT c.*, ca.CategoryName FROM CD c, Category ca WHERE c.CategoryCode = ca.CategoryCode AND Producer LIKE '%$search%'";
            $res = mysqli_query($mysqli, $query) or die(mysqli_error());
            $count = mysqli_num_rows($res);
            if($count > 0)
            {
